...
/**
 * @author "Hovercraft Full of Eels", "Rodrigo Azevedo", "Maritaria"
 *
 * @see <a href="https://gist.github.com/roooodcastro/6325153">From GitHub</a>
 *
 * "This code is a transformation of code that was posted on StackOverflow which
 * marks user contributions licensed under cc by-sa 3.0 with attribution required."
 *
 * Modified by Johnny Madigan:
 * - added current value getter
 * - added remove value method
 *
...
public final class GraphPanel extends JPanel {
    ...
    private final static Color yeet = new Color(199, 199, 199, 180);
    private final static Color lineColor = new Color(134, 33, 50, 180);
    ...
    public ArrayList<Integer> getValues() { return (ArrayList<Integer>) values; }
